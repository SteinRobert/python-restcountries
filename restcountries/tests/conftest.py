...
def fixture_mock_get_all_countries(requests_mock):
    ...
    """
    requests_mock.get("https://restcountries.eu/rest/v2/all",
...
def fixture_mock_get_all_countries_with_filter(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/all?fields=name;capital", json=[RSA, NGR, EGY, KEN])
...
def fixture_mock_get_countries_by_name(requests_mock):
    ...
    requests_mock.get(
        "https://restcountries.eu/rest/v2/name/nigeria", json=[NGR])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/name/egypt", json=[EGY])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/name/kenya", json=[KEN])
...
def fixture_mock_get_countries_by_name_with_filter(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/name/south%20africa?fields=name;currencies", json=[RSA]
    )
    requests_mock.get(
        "https://restcountries.eu/rest/v2/name/nigeria?fields=name;currencies", json=[NGR])
    requests_mock.get(
...
def fixture_mock_get_countries_by_country_codes_with_filter(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/alpha?codes=ng;eg;ken&fields=name;currencies", json=[NGR, EGY, KEN]
    )
...
def fixture_mock_get_countries_by_currency(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/currency/zar", json=[RSA])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/currency/ngn", json=[NGR])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/currency/egp", json=[EGY])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/currency/kes", json=[KEN])
...
def fixture_mock_get_countries_by_language(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/lang/en", json=[RSA, NGR, KEN])
...
def fixture_mock_get_countries_by_language_with_filter(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/lang/en?fields=name;flag", json=[RSA, NGR, KEN])
...
def fixture_mock_get_countries_by_capital(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/capital/pretoria", json=[RSA])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/capital/abuja", json=[NGR])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/capital/cairo", json=[EGY])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/capital/nairobi", json=[KEN])
...
def fixture_mock_get_countries_by_capital_with_capital(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/capital/pretoria?fields=name;demonym", json=[RSA])
    requests_mock.get(
    ...
    requests_mock.get(
        "https://restcountries.eu/rest/v2/capital/nairobi?fields=name;demonym", json=[KEN])
...
def fixture_mock_get_countries_by_calling_code(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/callingcode/27", json=[RSA])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/callingcode/234", json=[NGR])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/callingcode/20", json=[EGY])
    requests_mock.get(
        "https://restcountries.eu/rest/v2/callingcode/254", json=[KEN])
...
def fixture_mock_get_countries_by_region(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/region/europe", json=[])
    requests_mock.get(
...
def fixture_mock_get_countries_by_region_with_filter(requests_mock):
    ...
    requests_mock.get(
        "https://restcountries.eu/rest/v2/region/africa?fields=name", json=[RSA, NGR, EGY, KEN]
    )
...
def fixture_mock_get_countries_by_subregion_with_filter(requests_mock):
    ...
    """
    requests_mock.get(
        "https://restcountries.eu/rest/v2/subregion/southern%20africa?fields=name", json=[RSA]
    )
    requests_mock.get(
        "https://restcountries.eu/rest/v2/subregion/western%20africa?fields=name", json=[NGR]
    )
    requests_mock.get(
        "https://restcountries.eu/rest/v2/subregion/northern%20africa?fields=name", json=[EGY]
    )
    requests_mock.get(
        "https://restcountries.eu/rest/v2/subregion/eastern%20africa?fields=name", json=[KEN]
    )
